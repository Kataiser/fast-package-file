...
class TestTF2RichPresenseFunctions(unittest.TestCase):
    ...
    def test_errors(self):
        ...
        try:
            self.assertTrue(e.exception.args[0].startswith("test_compressed_bad_header.data is corrupted or malformed (loaded file format version is "))
        except AssertionError:
        ...
        self.assertTrue(e.exception.args[0].startswith("test_uncompressed_bad_filedata.data is corrupted or malformed (first byte of file 'conf.py' should be "))
